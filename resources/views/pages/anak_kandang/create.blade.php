...
<div class="row align-items-center">
    <div class="col-sm-6">
        <div class="page-title-box">
            <h4 class="font-size-18">Tambah Anak Kandang</h4>
            <ol class="breadcrumb mb-0">
                <li class="breadcrumb-item"><a href="javascript: void(0);">Anak Kandang </a></li>
                <li class="breadcrumb-item active">Tambah Anak Kandang</li>
            </ol>
        </div>
    </div>
...
<div class="row">
    <div class="col-md-6">
        <div class="card">
            <div class="card-body">
                <form action="/anak-kandang" method="POST">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" name="tanggal_lahir" data-date-format="yyyy-mm-dd" required placeholder="yyyy-mm-dd">
                    </div>
                    <div class="form-group">
