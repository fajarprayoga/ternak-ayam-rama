...
<div class="row align-items-center">
    <div class="col-sm-6">
        <div class="page-title-box">
            <h4 class="font-size-18">Edit Jadwal Panen</h4>
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item active">Edit Jadwal Panen</li>
            </ol>
        </div>
    </div>
...
<div class="row">
    <div class="col-md-6">
        <div class="card">
            <div class="card-body">
                <form action="{{route('jadwal-panen.update',$data->id)}}" method="POST">
                    @csrf
                    @method('PUT')
