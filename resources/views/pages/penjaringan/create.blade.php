...
<div class="row align-items-center">
    <div class="col-sm-6">
        <div class="page-title-box">
            <h4 class="font-size-18">Tambah Jadwal Penjaringan</h4>
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item active">Tambah Jadwal Penjaringan</li>
            </ol>
        </div>
    </div>
...
<div class="row">
    <div class="col-md-6">
        <div class="card">
            <div class="card-body">
                <form action="{{route('jadwal-penjaringan.store')}}" method="POST">
                    @csrf
